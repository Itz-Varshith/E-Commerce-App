...
const Add = ({token}) => {
  ...
  return (
    <form className='flex flex-col w-full items-start gap-3' onSubmit={(e)=>onSubmitHandler(e)}>
      <div>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e) => setName(e.target.value)} value={name} type='text' placeholder='Product name' required className='w-full max-w-[500px] px-3 py-2' />
      </div>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input type='number' placeholder='25' className='w-full px-3 py-2 sm:w-[120px]' onChange={(e) => setPrice(e.target.value)} />
        </div>
      </div>
